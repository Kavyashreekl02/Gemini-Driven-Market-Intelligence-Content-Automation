...
INSIGHTS_FILE = 'Code/reports/10_insights.json'
...
def generate_insights(df: pd.DataFrame) -> dict:
    ...
    3. At least 10 unique, actionable Market Insights (MI).
    ...
    - Assesment of market risk in high volume segments.
    - Evaluation of market freshness and maintaince.
    - Analysis of price elasticity and audience segmentation.
    - Analysis of technical market friction.
    """
